...
<head>
    ...
    <meta name="Keywords"
          content="phonelist, phone, contact, crewmembers, people, email, address, mail, fire, wildland, firefighting, suppression, helicopter, aviation, cofms, fire management, central, oregon, helitack, hecm, crew, prineville"/>
...
<div id="wrapper" style="min-height:150px;">
    <div id="banner">
        ...
        <div id="banner_text_bg" style="background: url(images/banner_text_bg2.jpg) no-repeat;">Wild Rivers Ranger
            District - Budget Helper
        </div>
    </div>
