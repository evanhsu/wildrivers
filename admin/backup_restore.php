...
<title>Backup / Restore Database :: Wild Rivers Ranger District</title>
...
<div id="wrapper">
	<div id="banner">
        ...
        <div id="banner_text_bg" style="background: url(images/banner_text_bg2.jpg) no-repeat;">Wild Rivers Ranger District - Data Integrity Console</div>
    </div>
