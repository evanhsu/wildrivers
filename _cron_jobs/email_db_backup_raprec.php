...
$subject = 'Weekly dB Backup: RapRec Central';
...
This message was sent automatically from the RapRec Central backup server.
...
ftp://siskiyourappellers.com/raprec/db_backups/

--PHP-alt-<?php echo $random_hash; ?> 
Content-Type: text/html; charset="iso-8859-1"
Content-Transfer-Encoding: 7bit

This message was sent automatically from the RapRec Central backup server.<br />
The file attachment contains the most recent backup copy of the database.  Although
a backup is performed daily, you will only receive an email copy once per week. The
un-mailed nightly backups will remain on the server for 7 days.<br />
<br />
<a href="ftp://siskiyourappellers.com/raprec/db_backups" target="_blank">ftp://siskiyourappellers.com/raprec/db_backups</a>
