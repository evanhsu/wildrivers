		...
		**/
		...
		function _encode_value($str) {
			if($this->isUTF8)
                ...
                // Modified to use mb_convert_encoding() instead of iconv() so this can run in
                // Alpine linux without having to compile iconv PHP extension from source
				$str="\xFE\xFF".mb_convert_encoding($str, 'UTF-16BE', 'UTF-8');
